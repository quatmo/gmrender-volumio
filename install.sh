...
TMPPATH="/tmp/gmedia"
sudo wget -O /$TMPPATH/gmediarender.tar.gz https://raw.githubusercontent.com/quatmo/gmrender-volumio/main/gmediarender.tar.gz
sudo wget -O /$TMPPATH/gmrender.service.tar.gz https://raw.githubusercontent.com/quatmo/gmrender-volumio/main/gmrender.service.tar.gz
